...
xfile add "../rtl/mimasv2_s6_memctrl.vhd"

xfile add "mimasv2_s6_memctrl.ucf"
...
project set "Library Search Order" "../synth/mimasv2_s6_memctrl.lso" -process "Synthesize - XST"
